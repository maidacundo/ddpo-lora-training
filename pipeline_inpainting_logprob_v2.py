...
class DPPOStableDiffusionInpaintPipeline(
    ...
    def __init__(
        ...
        # add the custom lora modules to the unet
        self.use_lora=False
    ...
    def _left_broadcast(self, input_tensor, shape):
        """
    ...
    def __call__(
        ...
        return DDPOPipelineOutput(image, all_latents, all_log_probs, mask, masked_image_latents)
